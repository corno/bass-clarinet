...
export const JSONTests: TestDefinitions = {
    ...
    "low overflow": {
        ...
        events: [
            ["openarray"],
            ["unquotedstring", "-9223372036854775808"],
            ["closearray", 1, 22],
            ["end"],
            ["ready"],
        ],
    ...
    "floats": {
        ...
        events: [
            ["openarray"],
            ["unquotedstring", "0.1e2"],
            ["unquotedstring", "1e1"],
            ["unquotedstring", "3.141569"],
            ["unquotedstring", "10000000000000e-10"],
            ["closearray"],
            ["end"],
            ["ready"],
        ],
    ...
    "numbers game": {
        ...
        events: [
            ...
            ["unquotedstring", "-0.3"],
            ["unquotedstring", "0.3"],
            ["unquotedstring", "1343.32"],
            ["unquotedstring", "3345"],
            ["unquotedstring", "3.1e124"],
            ["unquotedstring", "9223372036854775807"],
            ["unquotedstring", "-9223372036854775807"],
            ["unquotedstring", "0.1e2"],
            ["unquotedstring", "1e1"],
            ["unquotedstring", "3.141569"],
            ["unquotedstring", "10000000000000e-10"],
            ["unquotedstring", "0.00011999999999999999"],
            ["unquotedstring", "6E-06"],
            ["unquotedstring", "6E-06"],
            ["unquotedstring", "1E-06"],
            ["unquotedstring", "1E-06"],
            ["quotedstring", "2009-10-20@20:38:21.539575"],
            ["unquotedstring", "9223372036854775808"],
            ["unquotedstring", "123456789"],
            ["unquotedstring", "-123456789"],
            ["unquotedstring", "2147483647"],
            ["unquotedstring", "-2147483647"],
            ["closearray"],
            ["end"],
            ["ready"],
    ...
    "johnsmith": {
        text: '{ "firstName": "John", "lastName" : "Smith", "age" : ' +
            ...
            '"unquotedstring": "212 555-1234" }, { "type" : "fax", ' +
            '"unquotedstring": "646 555-4567" } ] }',
        events: [
            ["openobject"],
            ["key", "firstName"],
            ["quotedstring", "John"],
    ...
    "incomplete json terminates ending in number": {
        ...
        events: [
            ["openarray", 1, 1],
            ["openarray", 1, 2],
            ["unquotedstring", "1", 1, 3],
            ["unquotedstring", "2", 1, 5],
            ["unquotedstring", "3", 1, 7],
            ["closearray", 1, 8],
            ["openarray", 1, 10],
