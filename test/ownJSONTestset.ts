...
export const JSONTests: TestDefinitions = {
    ...
    "newline": {
        ...
        testForLocation: true,
        events: [
            ["token","quotedstring", "a string", [2, 3, 2, 13]],
            ["end", [2, 13]],
        ],
    },
    "just a number": {
    ...
    "key true": {
        ...
        events: [
            ...
            ["token","quotedstring"/*key*/, "foo", [1, 2, 1, 7]],
            ["token","unquotedtoken", "true", [1, 9, 1, 13]],
            ["token","quotedstring"/*key*/, "bar", [1, 15, 1, 20]],
            ["token","unquotedtoken", "false", [1, 22, 1, 27]],
            ["token","quotedstring"/*key*/, "baz", [1, 29, 1, 34]],
            ["token","unquotedtoken", "null", [1, 36, 1, 40]],
            ["token","closeobject", "}", [1, 40, 1, 41]],
            ["end", [1, 41]],
        ],
    },
    "obj strange strings": {
    ...
    "string invalid escape": {
        ...
        events: [
            ["token","openarray", "[", [1, 1, 1, 2]],
            ["token","quotedstring", 'and you can\'t escape this', [1, 2, 1, 29]],
            ["token","closearray", "]", [1, 29, 1, 30]],
            ["end", [1, 30]],
        ],
    },
    "nuts and bolts": {
    ...
    "low overflow": {
        ...
        events: [
            ["token","openarray", "[", [1, 1, 1, 2]],
            ["token","unquotedtoken", "-9223372036854775808", [1, 2, 1, 22]],
            ["token","closearray", "]", [1, 22, 1, 23]],
            ["end", [1, 23]],
        ],
    },
    "high overflow": {
    ...
    "array null": {
        ...
        events: [
            ["token","openarray", "[", [1, 1, 1, 2]],
            ["token","unquotedtoken", "null", [1, 2, 1, 6]],
            ["token","unquotedtoken", "false", [1, 7, 1, 12]],
            ["token","unquotedtoken", "true", [1, 13, 1, 17]],
            ["token","closearray", "]", [1, 17, 1, 18]],
            ["end", [1, 18]],
        ],
    },
    "empty array comma": {
    ...
    "incomplete json terminates ending in number": {
        ...
        events: [
            ["token","openarray", "[", [1, 1, 1, 2]],
            ["token","openarray", "[", [1, 2, 1, 3]],
            ["token","unquotedtoken", "1", [1, 3, 1, 4]],
            ["token","unquotedtoken", "2", [1, 5, 1, 6]],
            ["token","unquotedtoken", "3", [1, 7, 1, 8]],
            ["token","closearray", "]", [1, 8, 1, 9]],
            ["token","openarray", "[", [1, 10, 1, 11]],
            ["token","unquotedtoken", "42", [1, 11, 1, 13]],
            ["token","unquotedtoken", "0", [1, 14, 1, 15]],
            ['parsererror', 'unexpected end of document, still in array'],
            ['parsererror', 'unexpected end of document, still in array'],
            ["end", [1, 15]],
        ],
