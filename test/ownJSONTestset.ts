...
export const JSONTests: TestDefinitions = {
    ...
    "invalid key": {
        ...
        events: [
            ...
            ["quotedstring"/*key*/, "baz", undefined],
    ...
    "three byte utf8": {
        ...
        events: [
            ["openobject", "{", undefined],
            ["quotedstring"/*key*/, "matzue", undefined],
            ["quotedstring", "松江", undefined],
            ["quotedstring"/*key*/, "asakusa", undefined],
    ...
    "four byte utf8": {
        ...
        events: [
            ["openobject", "{", undefined],
            ["quotedstring"/*key*/, "U+10ABCD", undefined],
            ["quotedstring", "������", undefined],
            ["closeobject", "}", undefined],
            ["end", undefined],
        ],
    ...
    "as is": {
        ...
        events: [
            ...
            ["quotedstring"/*key*/, "bar", undefined],
    ...
    "array fu": {
        ...
        events: [
            ...
            ["openobject", "{", undefined],
            ["quotedstring"/*key*/, 'key', undefined],
    ...
    "key true": {
        ...
        events: [
            ["openobject", "{", [1, 1, 1, 2]],
            ["quotedstring"/*key*/, "foo", [1, 2, 1, 7]],
            ["unquotedtoken", "true", [1, 9, 1, 13]],
            ["quotedstring"/*key*/, "bar", [1, 15, 1, 20]],
            ["unquotedtoken", "false", [1, 22, 1, 27]],
            ["quotedstring"/*key*/, "baz", [1, 29, 1, 34]],
    ...
    "nuts and bolts": {
        ...
        events: [
            ["openobject", "{", undefined],
            ["quotedstring"/*key*/, "boolean, true", undefined],
            ["unquotedtoken", "true", undefined],
            ["quotedstring"/*key*/, "boolean, false", undefined],
            ["unquotedtoken", "false", undefined],
            ["quotedstring"/*key*/, "null", undefined],
            ["unquotedtoken", "null", undefined],
            ["closeobject", "}", undefined],
            ["end", undefined],
        ],
    ...
    "non utf8": {
        ...
        events: [
            ...
            ["quotedstring"/*key*/, "required", undefined],
            ["unquotedtoken", "true", undefined],
            ...
            ["quotedstring"/*key*/, "version", undefined],
            ["openobject", "{", undefined],
            ["quotedstring"/*key*/, "major", undefined],
            ["unquotedtoken", "0", undefined],
            ["quotedstring"/*key*/, "micro", undefined],
            ["unquotedtoken", "1", undefined],
            ["quotedstring"/*key*/, "minor", undefined],
            ["unquotedtoken", "0", undefined],
            ["closeobject", "}", undefined],
            ["quotedstring"/*key*/, "versionString", undefined],
    ...
    "johnsmith": {
        ...
        events: [
            ["openobject", "{", undefined],
            ["quotedstring"/*key*/, "firstName", undefined],
            ["quotedstring", "John", undefined],
            ["quotedstring"/*key*/, "lastName", undefined],
            ["quotedstring", "Smith", undefined],
            ["quotedstring"/*key*/, "age", undefined],
            ["unquotedtoken", "25", undefined],
            ["quotedstring"/*key*/, "address", undefined],
            ["openobject", "{", undefined],
            ["quotedstring"/*key*/, "streetAddress", undefined],
            ["quotedstring", "21 2nd Street", undefined],
            ["quotedstring"/*key*/, "city", undefined],
            ["quotedstring", "New York", undefined],
            ["quotedstring"/*key*/, "state", undefined],
            ["quotedstring", "NY", undefined],
            ["quotedstring"/*key*/, "postalCode", undefined],
            ["quotedstring", "10021", undefined],
            ["closeobject", "}", undefined],
            ["quotedstring"/*key*/, "phoneNumber", undefined],
            ["openarray", "[", undefined],
            ["openobject", "{", undefined],
            ["quotedstring"/*key*/, "type", undefined],
            ["quotedstring", "home", undefined],
            ["quotedstring"/*key*/, "unquotedtoken", undefined],
    ...
    "incomplete json terminates ending in number": {
        ...
        events: [
            ...
            ["closearray", undefined, [1, 15, 1, 15]],
            ['parsererror', 'unexpected end of document, still in array'],
            ["end", [1, 15]],
        ],
    },
    ...
    "json org": {
        ...
        events: [
            ["openobject", "{", undefined],
            ["quotedstring"/*key*/, "glossary", undefined],
            ["openobject", "{", undefined],
            ["quotedstring"/*key*/, "title", undefined],
            ["quotedstring", "example glossary", undefined],
            ["quotedstring"/*key*/, "GlossDiv", undefined],
            ["openobject", "{", undefined],
            ["quotedstring"/*key*/, "title", undefined],
            ["quotedstring", "S", undefined],
            ["quotedstring"/*key*/, "GlossList", undefined],
            ["openobject", "{", undefined],
            ["quotedstring"/*key*/, "GlossEntry", undefined],
            ["openobject", "{", undefined],
            ["quotedstring"/*key*/, "ID", undefined],
            ["quotedstring", "SGML", undefined],
            ["quotedstring"/*key*/, "SortAs", undefined],
            ["quotedstring", "SGML", undefined],
            ["quotedstring"/*key*/, "GlossTerm", undefined],
            ["quotedstring", "Standard Generalized Markup Language", undefined],
            ["quotedstring"/*key*/, "Acronym", undefined],
            ["quotedstring", "SGML", undefined],
            ["quotedstring"/*key*/, "Abbrev", undefined],
            ["quotedstring", 'ISO 8879:1986', undefined],
            ["quotedstring"/*key*/, "GlossDef", undefined],
            ["openobject", "{", undefined],
            ["quotedstring"/*key*/, "para", undefined],
            ["quotedstring", 'A meta-markup language, used to create markup languages such as DocBook.', undefined],
            ["quotedstring"/*key*/, "GlossSeeAlso", undefined],
            ["openarray", "[", undefined],
            ["quotedstring", "GML", undefined],
            ["quotedstring", "XML", undefined],
            ["closearray", "]", undefined],
            ["closeobject", "}", undefined],
            ["quotedstring"/*key*/, "GlossSee", undefined],
